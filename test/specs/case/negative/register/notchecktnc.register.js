...
describe('Customer did not check tnc register form', () => {
    ...
    it('should show error message when did not check tnc', async () => {
        ...
        await RegisterPage.register('pfmwdio1@yopmail.com', 'Pfm12345', 'Pfm12345', 'Pfm Wdio Satu', '', '0001112223330001', '8123400000001', '01-01-1985', false);
        await expect(RegisterPage.checkTnc).toBeDisplayed();
        await expect(RegisterPage.checkTnc).toHaveText('Harus diisi');
    });
