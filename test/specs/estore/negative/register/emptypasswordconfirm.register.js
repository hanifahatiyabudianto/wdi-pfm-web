...
describe('Customer did not fill password confirm register form', () => {
    ...
    after(() => {
        browser.saveScreenshot('test/screenshot/negative case/register/emptypasswordconfirmregister.png');
    });
    ...
    it('should show error message when empty password confirm', async () => {
        ...
        await expect(RegisterPage.messagePasswordConfirm).toBeDisplayed();
        await expect(RegisterPage.messagePasswordConfirm).toHaveText('Harus diisi');
    });
