...
describe('Customer did not fill email register form', () => {
    ...
    after(() => {
        browser.saveScreenshot('test/screenshot/negative case/register/emptyemailregister.png');
    });
    ...
    it('should show error message when empty email', async () => {
        ...
        //Customer did not fill email register form should show error message when empty email
