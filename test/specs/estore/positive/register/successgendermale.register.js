...
describe('Customer success register', () => {
    ...
    after(() => {
        browser.saveScreenshot('test/screenshot/positive case/register/success register gendermale.png');
    });

    it('should register with fill form data with gender is male', async () => {
